...
files.forEach(file => {
  ...
  if (!txt.includes('Layanan Surat') && txt.includes('Listing UMKM')) {
    txt = txt.replace(/<a href="\/admin\/listing\.html" class="sidebar-link"><span class="icon">🏪<\/span> Listing UMKM<\/a>/, 
